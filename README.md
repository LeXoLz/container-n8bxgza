...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n8bxgza.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n8bxgza.containers.anotherwebservice.com/
...
```
git clone git@github.com:LeXoLz/container-n8bxgza.git
cd container-n8bxgza
```
...
```
docker attach container-n8bxgza
```
